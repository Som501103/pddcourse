    ...
    try:
        ...
        if Emp_id == '501103' or Emp_id == '503710' or Emp_id == '499781' or Emp_id == '507599' or Emp_id == '492613' or Emp_id == '497784' or Emp_id == '510951' or Emp_id == '510187':
            ...
            #    print(courses)
                ...
                courses = Course_D.objects.all().filter(Course_ID = 'PDD01CO21').annotate(Gap_number =F('Number_App') - F('Number_People')).order_by('-PK_Course_D')
        ...
        open_course = len(Course_D.objects.filter(PK_Course_D = 16,status = 1))
        print("open_course",open_course)
        openorclose = Course_D.objects.get(PK_Course_D = 16)
